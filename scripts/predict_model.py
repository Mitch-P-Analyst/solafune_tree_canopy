...
with open(REPO_ROOT / 'configurations' / 'predict_model.yaml', 'r') as f:
...
weights = REPO_ROOT / 'runs/segment/training_fastNMS11/weights/best.pt' # Weights from Train Model
